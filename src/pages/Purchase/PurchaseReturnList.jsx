...
import { FiPlus, FiX, FiFileText, FiEdit2, FiDownload, FiPrinter, FiTrash2 } from "react-icons/fi";
    ...
    <body>
      ...
      <div class="grid">
        <div class="section">
          ...
          <div class="row"><span class="label">Vendor</span><span class="value">${note.partyName}</span></div>
...
const columns = [
  ...
  try {
    await axios.delete(`http://localhost:8000/api/purchase-return/${id}`);
      ...
      <Table
        ...
        headerActions={
          <Button onClick={() => navigate("/purchase-return/new")}>
            <FiPlus size={14} /> Create Purchase Return
          </Button>
        }
      />

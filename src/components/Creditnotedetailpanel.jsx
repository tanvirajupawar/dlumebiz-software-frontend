...
const CreditNoteDetailPanel = ({ note, onClose }) => {
  ...
  <html>
    <head>
      <title>Credit Note ${note.creditNo}</title>
      <style>
    ...
    <body>
      <h1>Credit Note</h1>
      <p>Customer: ${note.partyName}</p>
      <p>Credit No: ${note.creditNo}</p>
      <p>Date: ${note.date}</p>
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `CreditNote-${note.creditNo}.html`;
    a.click();
      ...
      >
        ...
        <div className="p-4 border-t border-gray-100 space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => navigate(`/credit-note/${note.id}/edit`)}
...
export default CreditNoteDetailPanel;
...
const SalesReturnDetailPanel = ({ note, onClose }) => {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `SalesReturn-${note.returnNo}.html`;
    a.click();
      ...
      >
        ...
        <div className="p-4 border-t border-gray-100 space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => navigate(`/sales-return/${note.id}/edit`)}
...
export default SalesReturnDetailPanel;